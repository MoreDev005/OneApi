...
let $ = cheerio.load(respon.data.template)
 ...
 let hd = `http://eu3.diresnode.com:3157/download/id?data=${encodeURIComponent(arrlink[0])}`;
 let sd = `http://eu3.diresnode.com:3157/download/id?data=${encodeURIComponent(arrlink[1])}`
 return {
 status:"sukses",
 author:"iwan",
